...
1. <b>JAVA API:</b> A programmer can develop various workflow tasks and workflows based on the DATAVIWE libraries. /DATAVIEW/src/test.java shows the six steps to create a cusomized workflow and execute in Amazon eC2.
...
2. <b>Visual Programming</b>: DATAVIEW is deployed as a web site and a user can drag and drop tasks and link them into a workflow in a visual workflow design and execution environment called <b>Webbench</b>. The project can run in tomcat as a dynamic web project with the login.jsp.
